  ...
  <body class="sidebar-mini fixed">
                ...
                <div class="card team_card">
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-6 col-sm-12 col-xs-12">
                      <h4>
                        {!! $team->team_name !!}<button class="btn btn-warning" style="position: absolute;right: 0;" onclick="requestmatch('{!! $team->team_id !!}')"><i class="fa fa-compress"></i> Request Match</button>
                      </h4>
                      <hr>
                      <div class="row">
    ...
    <script>
      function requestmatch(team_id){
        ...
        var url = '{!! url('/requestmatch') !!}'+'?team='+team_id;
